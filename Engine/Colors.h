...
namespace Colors
{
	...
	static constexpr Color Gray = MakeRGB( 93u,93u,93u );
	static constexpr Color LightGray = MakeRGB( 180u,180u,180u );
	static constexpr Color Red = MakeRGB( 255u,0u,64u );
	...
	static constexpr Color Slate = MakeRGB( 101u,115u,146u );
	static constexpr Color DarkSlate = MakeRGB( 0u,57u,109u );
	static constexpr Color Blue2 = MakeRGB( 0u,105u,170u );
}